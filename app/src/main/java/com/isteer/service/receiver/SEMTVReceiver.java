	...
	class TokenValidatorTask extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... urls) {
			...
			String postUrl = App.appPreference.getBaseUrl()
					+ SRVAppConstant.METHOD_VALIDATE_TOKEN + App.appPreference.getUserId() + "/"
		...
		protected void onPostExecute(String responseString) {
			...
			try {
				...
				if (responseJson.has(SRVAppConstant.KEY_RESULT) && responseJson.getBoolean(SRVAppConstant.KEY_RESULT)) {
